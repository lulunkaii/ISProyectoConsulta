...
from conexion_base_datos import ingresar_cita, imprimir_base_de_datos
...
@app.route('/obtener_horas_ocupadas', methods=['GET'])
def obtener_horas_ocupadas():
    ...
    horas_ocupadas = centro_medico.obtener_horas_agendadas()
    ...
    return jsonify(horas_filtradas)

@app.route('/ingresar_cita', methods=['POST'])
