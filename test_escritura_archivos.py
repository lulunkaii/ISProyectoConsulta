...
class TestEscrituraArchivos(unittest.TestCase):
    ...
    def test_escribir_a_archivo(self):
        ...
        escribir_a_archivo(nombre1, correo1, fecha1, rut1, motivo1)
        escribir_a_archivo(nombre2, correo2, fecha2, rut2, motivo2)
        escribir_a_archivo(nombre3, correo3, fecha3, rut3, motivo3)
